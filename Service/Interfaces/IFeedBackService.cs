...
namespace Service.Interfaces
{
    public interface IFeedBackService
    {
        ...
        Task<FeedBackViewModel> GetFeedBacksForDriver(Guid id, PaginationRequestModel pagination);
        Task<FeedBackViewModel> GetFeedBacksForCar(Guid id, PaginationRequestModel pagination);
